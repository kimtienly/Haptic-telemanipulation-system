"""
Deep Reinforcement class for training intent detection.
Generally finds the path to nearest target and phase among a block of trajectories.
...
class DeepQNetwork:
    ...
    def _build_net(self):
        """
        Build neural networks for training.
        """
        # all inputs
    ...
    def store_transition(self, s, a, r, s_):
        """
        Store the transition of the experience
        param s: current state
        param a: action taken at state s
        param r: reward that gets when taking action a at state s
        param s_: the expected state after taking action a at state s
        """
    ...
    def learn(self):
        """
        Get data from replay memory to learn.
        """
